    ...
    <div class="row ">
      ...
      <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
        <div class="panel panel-default">
         ...
         {
           $ambil = $koneksi->query("SELECT * FROM tbl_admin WHERE username='$_POST[user]' AND pass='$_POST[pass]'");
          #mencari akun yang cocok/benar
